...
/**
         * 
         * Esta funcion sirve para mostrar en pantalla un informe sobre los empleados (Muestra su Codigo,Categoria,Antiguedad).
         * Ademas tiene opciones que te permiten despedir y contratar.
         * @author Grupo 2
